...
# Footer
st.markdown('<div class="footer">Made with <span style='color:red;'>❤️ </span>by Neha | Loan Approval Prediction using ML Logistic Regression🚀</div>', unsafe_allow_html=True)
